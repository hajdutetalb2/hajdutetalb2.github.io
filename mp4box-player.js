var cdnmp4 = (function (exports, mp4box) {
  ...
  class Downloader {
    ...
    constructor(videoElement) {
      _defineProperty(this, "setDownloadTimeoutCallback", callback => {
      ...
      _defineProperty(this, "setRealTime", _realtime => {
        this.realtime = _realtime;
        return this;
      });
      _defineProperty(this, "setChunkSize", _size => {
        this.chunkSize = _size;
        return this;
      });
      _defineProperty(this, "setChunkStart", _start => {
        this.chunkStart = _start;
        this.eof = false;
        return this;
      });
      _defineProperty(this, "setInterval", _timeout => {
        this.chunkTimeout = _timeout;
        return this;
      });
      _defineProperty(this, "setUrl", _url => {
        this.url = _url;
        return this;
      });
      _defineProperty(this, "setCallback", _callback => {
        this.callback = _callback;
        return this;
      });
      _defineProperty(this, "isStopped", () => {
        return !this.isActive;
      });
      _defineProperty(this, "getFileLength", () => {
        return this.totalLength;
      });
      _defineProperty(this, "setCustomTotalLength", customTotalLength => {
       ...
       */
      _defineProperty(this, "setBufferFetcher", fetcher => {
  ...
  class Mp4boxPlayer {
    constructor(videoElement, initialDownloadConfig, downloaderInstance) {
      ...
      _defineProperty(this, "onStatusChange", callback => {
      ...
      _defineProperty(this, "onError", callback => {
        this.onErrorCallback = callback;
      });
      /* Callback END */
      _defineProperty(this, "processInbandCue", () => {
      ...
      _defineProperty(this, "addVideoEventListeners", () => {
      ...
      _defineProperty(this, "removeVideoEventListeners", () => {
        this.SHOW_LOGS && console.log("removeVideoEventListeners");
        this.video.removeEventListener("seeking", this.onSeeking);
        this.video.removeEventListener("playing", this.onPlaying);
      });
      _defineProperty(this, "onPlaying", e => {
      ...
      _defineProperty(this, "resetCues", () => {
      ...
      _defineProperty(this, "onWindowLoad", () => {
      ...
      _defineProperty(this, "resetDisplay", () => {
      ...
      _defineProperty(this, "resetMediaSource", () => {
      ...
      _defineProperty(this, "onSourceClose", e => {
      ...
      _defineProperty(this, "customDuration", null);
      _defineProperty(this, "setCustomDuration", duration => {
      ...
      _defineProperty(this, "initializeAllSourceBuffers", () => {
      ...
      _defineProperty(this, "initializeSourceBuffers", () => {
      ...
      _defineProperty(this, "updateBufferedString", (sb, string) => {
      ...
      _defineProperty(this, "setShouldSaveBuffers", shouldSaveBuffers => {
        this.shouldSaveBuffers = shouldSaveBuffers;
      });
      _defineProperty(this, "saveBuffer", (buffer, name) => {
      ...
      _defineProperty(this, "addSourceBufferListener", info => {
      ...
      _defineProperty(this, "addBuffer", (video, mp4track) => {
      ...
      _defineProperty(this, "removeBuffer", (video, track_id) => {
      ...
      /* Subtitles START */
      _defineProperty(this, "initTrackViewer", track => {
